...
parser.add_argument('--cutoff_freq', default=25, type=int)
...
parser.add_argument('--max_neighbors', type=int, default=10, help='Max number of neighbors for graph construction')
...
if __name__ == '__main__':
    ...
    for epoch in range(epoch_start_idx, args.num_epochs + 1):
        ...
        if epoch % 20 == 0:
            ...
            print('epoch:%d, time: %f(s), valid (NDCG@K: %.4f, HR@K: %.4f, MRR@10: %.4f), test (NDCG@10: %.4f, HR@10: %.4f, MRR@10: %.4f)'
